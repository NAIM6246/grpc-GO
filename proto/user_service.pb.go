...
var file_user_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x19, 0x0a, 0x07, 0x52,
	0x65, 0x71, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x02, 0x49, 0x64, 0x22, 0x2d, 0x0a, 0x07, 0x52, 0x65, 0x73, 0x55, 0x73, 0x65,
	...
	0x04, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0x38, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x73, 0x55, 0x73, 0x65, 0x72, 0x42,
...
var file_user_service_proto_goTypes = []interface{}{
	...
	(*ResUser)(nil), // 1: proto.ResUser
}
var file_user_service_proto_depIdxs = []int32{
	0, // 0: proto.UserService.GetUser:input_type -> proto.ReqUser
	1, // 1: proto.UserService.GetUser:output_type -> proto.ResUser
...
func (c *userServiceClient) GetUser(ctx context.Context, in *ReqUser, opts ...grpc.CallOption) (*ResUser, error) {
	out := new(ResUser)
...
func (*UnimplementedUserServiceServer) GetUser(context.Context, *ReqUser) (*ResUser, error) {
...
func _UserService_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUser(ctx, req.(*ReqUser))
	}
